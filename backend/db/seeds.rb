...
pet_name = ["Theodore", "Rusty", "Iggy", "Schmoodles", "Finn", "Ivy", "Goldie", "Dirty Harry", "Marshmello", "Gus", "Chance", "Rocky", "Wentworth", "Deogee", 'Dolly', 'Houdini', 'Perra', 'Captain', 'Mate', 'Jimbo', 'Dumbo', 'Lady', 'Princess', 'Tortilla', 'Chewy', 'Yoda', 'Luna', 'Milo', 'Bailey', 'Roscoe', 'Scout', 'Buddy', 'Cooper', 'Sadie', 'Bella', 'Loki', 'Zeus', 'Kona', 'Remi', 'Pepper', 'Piper', 'Bandit', 'Winnie', 'Oreo', 'Nova', 'Diesel', 'Shadow', 'Maya', 'Toby', 'Boomer', 'Nala', 'Finn', 'Peanut', 'Harley', 'Ollie', 'Willow', 'Bruno', 'Lucy', 'Jasper', 'Roxy', 'Simba', 'Rex', 'Thor', 'Rocco', 'Gypsy', 'Lola', 'Shiloh', 'Cash']
...
agency = Agency.create(name: 'OHOHOH', established: 2020, description: "At Open Hands, Open Hearts, Open Home we believe that all animals deserve a safe and loving environment. We strive to place all of our pets in loving homes. Our staff is highly skilled and trained in not just caring for the physical needs of our animals but the emotional needs as well. Additionally, our pet adoption counselors facilitate the adoption process by assessing the personalities and needs of animals and determining whether a potential human adopter or family of adopters is a good match. Take your time viewing our pets, reading their bios, and getting to know them, in our experience most find a new member of their family.")
